    ...
    <section id="contact" className="py-24 bg-black relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          {/* Contact Info */}
          <div>
            <h2 className="text-3xl sm:text-4xl font-heading font-bold text-white uppercase mb-8">
        ...
        {/* Map Embed */}
        <div className="mt-16 w-full h-64 sm:h-72 lg:h-80 rounded-sm overflow-hidden grayscale hover:grayscale-0 transition-all duration-500">
           <iframe 
