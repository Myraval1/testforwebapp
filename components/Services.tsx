      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          ...
          <div className="group relative overflow-hidden rounded-lg h-60 sm:h-72 md:h-80">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent opacity-90"></div>
            <div className="absolute bottom-0 left-0 p-4 sm:p-6">
              <Zap className="h-6 sm:h-8 w-6 sm:w-8 text-titan-gold mb-2 sm:mb-3" />
              <h4 className="text-lg sm:text-2xl font-heading font-bold text-white mb-1 sm:mb-2 uppercase">Beneficios</h4>
