  ...
  return (
    <section id="features" className="py-20 bg-titan-dark relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8 relative z-10 -mt-20 sm:-mt-32">
          {features.map((feature, index) => (
            ...
            >
              <div className="bg-zinc-800 w-16 sm:w-20 h-16 sm:h-20 rounded-full flex items-center justify-center mb-6">
                {feature.icon}
              </div>
              <h3 className="text-lg sm:text-2xl font-heading font-bold text-white mb-4 uppercase">{feature.title}</h3>
